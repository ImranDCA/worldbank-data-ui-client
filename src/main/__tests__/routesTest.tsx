import { expectToBeVisible, expectToNotExist, find, getApplicationWrapper, currentHistory, wait, expectToBeHidden, printDocumentHtml } from "../../utils/test/";
...
describe('routes', () => {
  ...
  it('/ shows home', async () => {
    ...
    // writeFileSync('test/test1.html', printDocumentHtml())
